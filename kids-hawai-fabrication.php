...
// Filter: Kids + (Hawai OR Fabrication)
$whereClauses = ["a.name LIKE '%Kids%'", "(c.name LIKE '%Hawai%' OR c.name LIKE '%Fabrication%')"];
...
<head>
    <meta charset="UTF-8">
    <title>Kids' Hawai & Fabrication | Indus Footwear</title>
...
<body class="bg-orange-50">
    ...
    <div class="relative h-72 bg-orange-900 flex items-center justify-center overflow-hidden">
        <img src="https://placehold.co/1920x400/f97316/white?text=Little+Essentials" alt="Kids Hawai Banner" class="absolute inset-0 w-full h-full object-cover opacity-40">
        ...
        <div class="relative z-10 text-center px-4 animate-fade-in-up">
            <h1 class="text-3xl md:text-5xl font-bold text-white tracking-widest uppercase shadow-sm">Daily Fun</h1>
            <p class="text-orange-100 mt-2 font-medium text-lg">Comfortable Hawai & Sturdy Fabrication.</p>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="flex flex-col items-center mb-10">
            ...
            <p class="text-gray-600 text-center max-w-2xl">Colorful rubber slippers and sturdy strap sandals.</p>
        </div>
            ...
            <?php if ($result->num_rows > 0): ?>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group overflow-hidden border border-gray-200">
                    <a href="product_detail.php?id=<?php echo $row['id']; ?>">
                        ...
                        <div class="p-4">
                            <span class="bg-orange-100 text-orange-800 text-xs font-bold px-2 py-0.5 rounded">Daily Wear</span>
