...
// Filter: Kids + (EVA OR Sports)
$whereClauses = ["a.name LIKE '%Kids%'", "(c.name LIKE '%EVA%' OR c.name LIKE '%Sport%')"];
...
<head>
    <meta charset="UTF-8">
    <title>Kids' EVA & Sports | Indus Footwear</title>
...
<body class="bg-orange-50">
    ...
    <div class="relative h-72 bg-orange-800 flex items-center justify-center overflow-hidden">
        <img src="https://placehold.co/1920x400/f97316/white?text=Kids+Active" alt="Kids EVA Banner" class="absolute inset-0 w-full h-full object-cover opacity-40">
        ...
        <div class="relative z-10 text-center px-4 animate-fade-in-up">
            <h1 class="text-3xl md:text-5xl font-bold text-white tracking-widest uppercase shadow-sm">Active Kids</h1>
            <p class="text-orange-100 mt-2 font-medium text-lg">Lightweight EVA & Sports Shoes.</p>
        </div>
    </div>

    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="flex flex-col items-center mb-10">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 text-center">EVA & Sports</h2>
            <div class="w-20 h-1 bg-orange-500 mt-2 mb-4"></div>
            <p class="text-gray-600 text-center max-w-2xl">Flexible and fun footwear for active play.</p>
        </div>
            ...
            <?php if ($result->num_rows > 0): ?>
                ...
                <div class="bg-gray-50 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 group overflow-hidden border border-gray-100">
                    <a href="product_detail.php?id=<?php echo $row['id']; ?>">
                        ...
                        <div class="p-4">
                            <span class="bg-orange-100 text-orange-800 text-xs font-bold px-2 py-0.5 rounded">Sports/EVA</span>
