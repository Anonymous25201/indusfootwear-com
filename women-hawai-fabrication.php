...
// Filter: Women + (Hawai OR Fabrication)
$whereClauses = ["a.name LIKE '%Women%'", "(c.name LIKE '%Hawai%' OR c.name LIKE '%Fabrication%')"];
...
<head>
    <meta charset="UTF-8">
    <title>Women's Hawai & Fabrication | Indus Footwear</title>
...
<body class="bg-pink-50">
    ...
    <div class="relative h-72 bg-teal-900 flex items-center justify-center overflow-hidden">
        <img src="https://placehold.co/1920x400/0f766e/white?text=Daily+Essentials" alt="Women's Hawai Banner" class="absolute inset-0 w-full h-full object-cover opacity-40">
        ...
        <div class="relative z-10 text-center px-4 animate-fade-in-up">
            ...
            <p class="text-teal-100 mt-2 font-medium text-lg">Soft Hawai & Sturdy Fabrication.</p>
        </div>
    </div>

    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="flex flex-col items-center mb-10">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 text-center">Ladies Hawai & Fab</h2>
            <div class="w-20 h-1 bg-teal-500 mt-2 mb-4"></div>
            <p class="text-gray-600 text-center max-w-2xl">Durable strap sandals and soft rubber slippers.</p>
        </div>
